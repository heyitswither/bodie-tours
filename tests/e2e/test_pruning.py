...
def test_pruning_reminder_guest_and_duplicate_prevention(mock_db):
    ...
    mock_booking_doc.to_dict.return_value = {
        ...
        "party_size": 2,
        "payment_status": "PENDING",
        "guest": {"name": "Alice Guest", "email": "alice@example.com"},
    }
    ...
    with patch(
        "prune_unpaid_slots.send_outlook_reminder", return_value=True
        ...
        tour_datetime_str = tour_datetime.astimezone(
